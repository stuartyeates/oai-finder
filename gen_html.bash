...
#for i in {1..21000}; do
#    wget --force-directories --directory-prefix=./cache-handle-brute-force/ --wait=10 --random-wait --convert-links --tries=1 --timeout=5 http://hdl.handle.net/${i}/1
#    wget --force-directories --directory-prefix=./cache-handle-brute-force/ --wait=10 --random-wait --convert-links --tries=1 --timeout=5 http://hdl.handle.net/${i}/12
#    wget --force-directories --directory-prefix=./cache-handle-brute-force/ --wait=10 --random-wait --convert-links --tries=1 --timeout=5 http://hdl.handle.net/${i}/123
#    wget --force-directories --directory-prefix=./cache-handle-brute-force/ --wait=10 --random-wait --convert-links --tries=1 --timeout=5 http://hdl.handle.net/${i}/1234
#    sleep 1
#done 

#for i in {15000..21000}; do echo http://cdm$i.contentdm.oclc.org/; done > html/cdm_urls
# wget --input-file=html/cdm_urls --force-directories --directory-prefix=./cache-cdm-brute-force/ --wait=10 --convert-links --tries=1 --timeout=5

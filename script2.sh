...
#check for the most distinctive and language-independent search-terms we have across all active top level domains
...
for n in 1 51 101 151 201 251 301 351 401 451 501 551 601 651 701 751 801 851 901 951 ; do
    echo "https://www.bing.com/search?q=\"verb%3didentify\"+OAI-PMH&count=50&first=${n}"  >> microsoft.urls
done;

...
#check for repository-specific search terms in great depth, out to the max 1000 results
...
for n in 1 51 101 151 201 251 301 351 401 451 501 551 601 651 701 751 801 851 901 951 ; do
    echo "https://www.bing.com/search?q=\"verb%3didentify\"+OAI-PMH&count=50&first=${n}"  >> build/microsoft.urls
done;
...
for n in 1 2 3 4 5 6 7 8 9 ; do
    echo "http://www.sogou.com/web?query=%22verb%3Didentify%22 OAI-PMH&page=${n}" >> build/sogou.urls
done;
